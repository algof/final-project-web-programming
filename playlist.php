...
<section class="videos-container">
   ...
   <div class="box-container">
      ...
      ?>
      <!-- satu box akan mengarahkan ke watch_video.php ga cuman tombol play video atau tulisan namanya -->
      <a href="watch_video.php?get_id=<?= $fetch_content['id']; ?>" class="box">
         <i class="fas fa-play"></i>
         <img src="uploaded_files/<?= $fetch_content['thumb']; ?>" alt="thumbnail-video">
         <h3><?= $fetch_content['title']; ?></h3>
      </a>
      <?php
            }
         }else{
            echo '<p class="empty">Mohon maaf, belum ada video yang diupload!</p>';
         }
      ?>
